...
// Database Configuration
  $dbinfo = array(
    ...
    "db" => 'url',            // The database where you have dumped the included sql file
  ...
  $config = array(
     ...
     *    fail.
     *
     *  - If the two config below don't have any values or have foxrocks or e5e60cb0454568b34da0393d2fff18d2, replace these by a random key.
     ====================================================================================
    */
    "security" => 'foxrocks',  // !!!! DON'T CHANGE THIS IF YOUR SITE IS LIVE !!!!
    "public_token" => 'e5e60cb0454568b34da0393d2fff18d2', // This is randomly generated and it is a public key
