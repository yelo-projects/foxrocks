...
<div class="panel panel-default">
  <div class="panel-heading">
    <?php if(!empty($this->id)) echo "User's " ?>URLs <?php echo $count ?>
    <div class="btn-group pull-right ">
      <a href="<?php echo Main::ahref("urls/export") ?>" class="btn btn-primary btn-xs">Export</a>
      <a href="<?php echo Main::ahref("urls/inactive").Main::nonce("inactive_urls") ?>" class="btn btn-danger delete btn-xs">Delete Inactive URLs</a>
      <a href="<?php echo Main::ahref("urls/flush").Main::nonce("flush") ?>" class="btn btn-danger delete btn-xs">Delete all anonymous URLs</a>
    </div>    
  </div>      
