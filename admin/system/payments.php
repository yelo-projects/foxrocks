        ...
        <tbody>          
          <?php foreach ($payments as $payment): ?>
            <tr data-id="<?php echo $payment->id ?>">
              ...
              <td><?php echo (($payment->status!=="Completed")?"<a href='".Main::ahref("payments/review/{$payment->id}?".Main::nonce())."' class='btn btn-xs btn-primary'>{$payment->status} (Mark as Completed)</a>":$payment->status) ?></td>
